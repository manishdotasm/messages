...
export interface DivProps
	extends React.HTMLAttributes<HTMLDivElement>, // Use HTMLAttributes instead of DivHTMLAttributes
		VariantProps<typeof divVariants> {
	asChild?: boolean;
}

const Div = React.forwardRef<HTMLDivElement, DivProps>(({ className, variant, size, asChild = false, ...props }, ref) => {
	const Comp = asChild ? Slot : "div";
	return <Comp className={cn(divVariants({ variant, size, className }))} ref={ref} {...props} />;
});
