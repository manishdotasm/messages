...
const DrawerContent = React.forwardRef<React.ElementRef<typeof DrawerPrimitive.Content>, React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Content>>(({ className, children, ...props }, ref) => (
	<DrawerPortal>
		<DrawerOverlay />
		<DrawerPrimitive.Content ref={ref} className={cn("fixed right-0 top-0 z-50 h-full w-[300px] border-2 border-border dark:border-darkBorder bg-white dark:bg-darkBg font-bold", className)} {...props}>
			{children}
